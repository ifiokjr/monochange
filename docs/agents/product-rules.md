...
- `crates/monochange_config` may normalize legacy syntax, but it should delegate ecosystem/provider validation to adapter crates whenever behavior depends on a specific implementation.
