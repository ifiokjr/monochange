...
6. Optionally generate a readiness artifact in CI with `mc publish-readiness --from HEAD --output .monochange/readiness.json` for preflight review or publish planning.
