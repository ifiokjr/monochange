...
It does not publish package artifacts to registries. Package publishing lives in the built-in top-level `mc step:publish-packages`, `mc step:publish-readiness`, and `mc step:placeholder-publish` commands.
