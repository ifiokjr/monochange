...
#[component]
fn NavLink(path: &'static str, label: &'static str, active: Signal<bool>) -> impl IntoView {
	view! {
		<a
			href=path
			class=move || {
...
#[component]
fn MobileNavLink(path: &'static str, label: &'static str) -> impl IntoView {
	view! {
		<a
			href=path
