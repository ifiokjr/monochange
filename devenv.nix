...
in
{
  ...
  scripts = {
    ...
    "lint:js" = {
      exec = ''
        set -euo pipefail
        env -u LD_LIBRARY_PATH -u LD_PRELOAD -u LD_AUDIT -u NIX_LD -u NIX_LD_LIBRARY_PATH pnpm exec oxlint --type-aware .
      '';
    ...
    "lint:js:syntax" = {
      exec = ''
        set -euo pipefail
        env -u LD_LIBRARY_PATH -u LD_PRELOAD -u LD_AUDIT -u NIX_LD -u NIX_LD_LIBRARY_PATH pnpm exec oxlint .
      '';
    ...
    "lint:js:types" = {
      exec = ''
        set -euo pipefail
        env -u LD_LIBRARY_PATH -u LD_PRELOAD -u LD_AUDIT -u NIX_LD -u NIX_LD_LIBRARY_PATH pnpm exec tsgo -config tsconfig.json
      '';
    ...
    "fix:js" = {
      exec = ''
        set -euo pipefail
        env -u LD_LIBRARY_PATH -u LD_PRELOAD -u LD_AUDIT -u NIX_LD -u NIX_LD_LIBRARY_PATH pnpm exec oxfmt --write .
      '';
    ...
    "build:js" = {
      exec = ''
        set -euo pipefail
        env -u LD_LIBRARY_PATH -u LD_PRELOAD -u LD_AUDIT -u NIX_LD -u NIX_LD_LIBRARY_PATH pnpm exec tsdown
      '';
